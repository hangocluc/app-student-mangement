...
const CUSTOM_TEXTFIELD_MAX_LENGTH = 255;
...
class _AppCustomTextFieldState extends State<AppCustomTextField> {
  ...
  JustTheController controllerToolTip = JustTheController();
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          ...widget.isRequired == true
                              ...
                              : [],
                          ...widget.isShowIcTitle == true
                              ? [
                                  WidgetSpan(
                                    child: GestureDetector(
                                      onTap: () {
                                        if (widget.tooltipWidget != null) {
                                          controllerToolTip.showTooltip();
                                        }
                                      },
                                      child: Padding(
                      ...
                      builder: (context, errorMessage, child) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: value
                                ...
                                : (widget.errorText?.value ?? '').isNotEmpty
                                    ...
                                    : [],
                            border: Border.all(
                                color: AppColors.theBlack.theBlack200),
                            borderRadius:
                          ...
                          child: TextFormField(
                            ...
                            maxLength:
                                widget.maxLength ?? CUSTOM_TEXTFIELD_MAX_LENGTH,
                            maxLines:
                                widget.maxLine ?? CUSTOM_TEXTFIELD_MAX_LINE,
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: SizedBox(
                                    height: 24.h,
                                    width: widget.isDropDown
                                        ? null
                                        : widget.suffixIcon.isNotNullOrEmpty
                                            ? 44.w
                                            : 0.w,
                                    child: widget.suffixIcon.isNotNullOrEmpty
                                        ? AppAssetImage(
                                            ...
                                            color:
                                                AppColors.theBlack.theBlack800,
                                          )
                                        : Container(),
                                  ),
                                ),
